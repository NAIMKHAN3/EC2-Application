...
const paymentInstance = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = {
            ...
            currency: 'BDT',
            tran_id,
            success_url: `https://resilient-boba-d81d5d.netlify.app/payment-success/${tran_id}`,
            fail_url: 'https://resilient-boba-d81d5d.netlify.app/payment-failed',
            cancel_url: 'https://resilient-boba-d81d5d.netlify.app/payment-canceled',
