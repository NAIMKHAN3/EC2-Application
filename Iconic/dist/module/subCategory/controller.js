...
exports.updateSubCategory = exports.deleteSubCategory = exports.getSubCategorySingle = exports.getSubCategoryAll = exports.createSubCategory = void 0;
...
const getSubCategoryAll = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getSubCategoryAll = getSubCategoryAll;
const getSubCategorySingle = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getSubCategorySingle = getSubCategorySingle;
const deleteSubCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const findOrder = yield prisma_1.default.subCategory.findUnique({
            where: {
                id
            },
        });
